...
kill %1
```
Esperado: JSON com `"items"` contendo "Checkout sem etapa de confirmação". Não use
`curl localhost:8080/mcp` (GET) para esperar o servidor subir: no modo sem estado o GET
abre um stream SSE que nunca fecha, e o curl fica pendurado.
