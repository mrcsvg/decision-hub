"""Modelos de saída das oito ferramentas.

Cada ferramenta declara `outputSchema` a partir destes modelos e responde com
`structuredContent` no formato `{data, pending}` de MCP_TOOLS.md.
